...
//  AVRecord
//
//  Created by HolyDavid on 2015. 10. 29..
//  Copyright © 2015년 HolyDavid. All rights reserved.
//
...
class ViewController: UIViewController, AVAudioRecorderDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    func refreshRecordingList(){
        print("files : \(recordFiles)")
        recordFiles.removeAll(keepCapacity: false)
        
        let docPath = NSSearchPathForDirectoriesInDomains(NSSearchPathDirectory.DocumentationDirectory, NSSearchPathDomainMask.UserDomainMask, true)[0]
